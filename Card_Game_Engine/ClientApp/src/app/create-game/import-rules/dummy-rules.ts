        ...
        "triggers": [
          {
            ...
            "parameters": [
              {
                "id": 3,
                "value": "3,4,28,2,20,27,34,46,45,44,21,14"
              },
              {
                "id": 7,
                "value": "0"
            ...
            "actions": [
              {
                ...
                "parameters": [
                  ...
                  {
                    "id": 8,
                    "value": "3,4,28,34,2,27,20,45,46,44,21,14"
                  }
                ]
              }
            ],
        ...
        "actions": [
          {
            ...
            "parameters": [
              {
                "id": 7,
                "value": "42,43,44,45,46,47,48,41,40,39,38,37,36,35,28,29,30,31,32,33,34,27,26,25,24,23,22,21,14,15,16,17,18,19,20,13,12,11,10,9,8,7,1,2,3,4,5,6"
              },
              {
                "id": 2,
                "value": "0"
    ...
    "manualTriggers": [
      {
        "id": -1,
        "name": "Collect Cards",
        "description": "Collects all the cards and calculate scores",
        "visibleTo": [
          -1
        ]
      },
...
export const gameJson = JSON.stringify(defaultGameObject, null, 2);
